    ...
    : ViewModelBase, ISaveControl
{
     ...
     */
    [ObservableProperty]
    public partial decimal Channel { get; set; } = renderer.Channel;

    /**
     * The minimum channel number.
     */
    [ObservableProperty]
    public partial decimal Min { get; set; } = 0;

    /**
     * The maximum channel number.
     */
    [ObservableProperty]
    public partial decimal Max { get; set; } = model.Sequence.Shape.Channels - 1;
