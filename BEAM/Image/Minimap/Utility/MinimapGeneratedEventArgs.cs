...
/// <summary>
/// Event arguments for the event whcih is raised when a minimap finishes generating its values for all lines of a sequence.
/// </summary>
public class MinimapGeneratedEventArgs(MinimapCreator origin, MinimapGenerationResult result) : EventArgs
{
    ...
    /// <summary>
    /// The result fo the specified minimaps generation process. MinimapGenerationResult.Failure means the generation failed hence the minimap is not operational.
    /// </summary>
